...
insert  into `system_property`(`id`,`system_id`,`name`,`display_name`,`value_type_id`,`default_value`,`description`) values (1,1,'url','URL',2,NULL,''),(2,1,'username','Username',1,NULL,NULL),(3,1,'password','Password',4,NULL,''),(4,1,'taskLastUpdateDateTime','Task Last Update DateTime',7,NULL,'Follow GMT time and format should be e.g. 2015-10-28T09:58:00:000+0000'),(5,1,'issueLastUpdateDateTime','Issue Last Update DateTime',7,NULL,'Follow GMT time and format should be e.g. 2015-10-28T09:58:00:000+0000'),(6,1,'syncTask','Sync Task',9,'true',NULL),(7,1,'syncIssue','Sync Issue',9,'true',NULL),(8,2,'url','URL',2,NULL,''),(9,2,'username','Username',3,NULL,''),(10,2,'password','Password',4,NULL,''),(11,2,'lastUpdateDateTime','Last Update DateTime',7,'','Follow GMT time and format should be e.g. 2015-10-28T09:58:00:000+0000'),(12,2,'customfield_issue','customfield_issue',3,NULL,NULL),(13,2,'customfield_task','customfield_task',3,NULL,NULL),(14,2,'customfield_assignees','customfield_assignees',3,NULL,NULL),(15,3,'pollingFrequency','Polling Frequency (In Minutes)',5,'30',NULL);
...
insert  into `users`(`id`,`customer_id`,`email`,`first_name`,`is_active`,`last_login_date`,`last_name`,`password`,`role_id`,`is_default_system_administrator`,`reset_password`,`roles_id`) values (1,NULL,'root','Root','','2015-10-26 11:39:52','User','0e7517141fb53f21ee439b355b5a1d0a',1,'\0','\0',NULL);
